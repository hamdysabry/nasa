...
// }
import 'package:flutter/material.dart';
import 'package:nasa_app/layout/quizes_layout/blackhall_quiz.dart';
import 'package:nasa_app/layout/quizes_layout/exoplanet_quiz.dart';
import 'package:nasa_app/layout/quizes_layout/solor_quiz.dart';
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const SolorQuiz()),
                      );
                    },
                    child: Stack(
                      children: [
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const BlackhallQuiz()),
                      );
                    },
                    child: Stack(
                      children: [
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const ExoplanetsQuiz()),
                      );
                    },
                    child: Stack(
                      children: [
